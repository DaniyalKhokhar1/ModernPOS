...
if (user_group_id() != 1 && !has_permission('access', 'read_buy_sell_report')) {
	redirect(root_url() . '/' . ADMINDIRNAME . '/dashboard.php');
}

// Set Document Title
$document->setTitle(trans('title_buy_sell_report'));
$document->setBodyClass('sidebar-collapse');

// Add Script
$document->addScript('../assets/itsolution24/angular/controllers/ReportBuySellController.js');
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<h1>
			<?php echo trans('text_buy_sell_report_title'); ?>
			<small>
				<?php echo store('name'); ?>
			</small>
		</h1>
				...
				<div id="collection-report" class="col-md-12">
					<div class="box box-info">
						<div class="box-header with-border" style="padding: 12px 10px;">
							<h3 class="box-title">
								<?php echo trans('text_buy_sell_report'); ?>
							</h3>
