window.angularApp.controller("ReportBuySellController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
    ...
    "EmailModal",
    function ($scope, API_URL, window, $, $http, UserInvoiceDetailsModal, DueCollectionDetailsModal, UserInvoiceDueDetailsModal, EmailModal) {
        "use strict";
        ...
        collectionReportDT.dataTable({
            ...
            aoColumns: [{ data: "sl" }, { data: "username" }, { data: "invoice_count" }, { data: "net_amount" }, { data: "prev_due_collection" }, { data: "due_collection" }, { data: "due_given" }, { data: "received_amount" }],
            ...
            buttons: [
                {
                    ...
                    customize: function (win) {
                        $(win.document.body)
                            ...
                            .prepend('<div class="dt-print-heading"><img class="logo" src="' + window.logo + '"/><h2 class="title">' + window.store.name + "</h2><p>Printed on: " + window.formatDate(new Date()) + "</p></div>");
